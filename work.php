...
<body class="body" style=" background-color: rgb(211,211,211)" ;>
    ...
    <section class="my-4">
        <div class="py-4">
            <h1 class="text-center"> <kbd>Natural Photography</kbd></h1>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/n4.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/n3.jpg" class="img-fluid pb-4">
                </div>
    ...
    <section class="my-4">
        <div class="py-4">
            <h1 class="text-center"> <kbd>Wildlife Photography</kbd></h1>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/Wildlife2.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/w3.jpg" class="img-fluid pb-4" sizes="40px, 60px">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/w4.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/w2.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/w6.jpg" class="img-fluid pb-4">
                </div>
    ...
    <section class="my-4">
        <div class="py-4">
            <h1 class="text-center"> <kbd>Portrait Photography</kbd></h1>
        </div>

        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/p1.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/p2.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/p3.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/p.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
                    <img src="images/p4.jpg" class="img-fluid pb-4">
                </div>
                <div class="col-lg-4 col-md-3 col-10">
        ...
        <footer>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col item social"><a href="https://www.facebook.com/" target="_blank"><i class="icon ion-social-facebook"></i></a><a href="https://www.twitter.com" target="_blank"><i class="icon ion-social-twitter"></i></a><a href="https://www.snapchat.com" target="_blank"><i class="icon ion-social-snapchat" target="_blank"></i></a><a href="https://www.instagram.com"><i class="icon ion-social-instagram" target="_blank"></i></a></div>
                </div>
