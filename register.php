...
<body>
    ...
    <div class="py-4">
        <h1 class="text-center"> <kbd>Register yourself here</kbd></h1>
    </div>

    <form class="my-4 bg-light" action="registerinfo.php" method="post">
        <div class="imgcontainer">
            <img src="images/glf.png" alt="logo" height=80vh width="80px"><br><br>
        ...
        <div class="container">
            <div class="form-group">
                ...
                <input type="text" name="yourfullname" autocomplete="off" class="form-control" required>
            </div>
            <div class="form-group">
                <label> Your Mobile No. &nbsp;&nbsp;</label>
                <input type="text" name="yourmobileno" autocomplete="off" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="youremail" autocomplete="off" class="form-control" required>
            </div>
            <div class="form-group">
                <label> Your Password &nbsp;&nbsp;&nbsp;</label>
                <input type="password" name="yourpassword" autocomplete="off" class="form-control" required>
            </div>

            <div class="form-group" style="text-align: center; padding-top: 10px;">
                <button id="register" type="submit" style="border-radius: 50%; width: 30%;">
                    <h2>Register</h2>
                </button>
            </div>
